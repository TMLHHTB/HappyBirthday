...
<body>
    ...
    <div id="castle" style="display: none;">
        <div class="letter">
            <div class="valentines">
                ...
                <div class="front"></div>
                <div class="card">
                    <div class="text">Wishing</br>You A Happy</br>Birthday!</div>
                    <div class="heart"></div>
                </div>
                <div class="hearts">
                    <div class="one"></div>
                    ...
                    <div class="wrapperLetter">
                        ...
                        <div class="textLetter">
                            ...
                            <div class="heartAnimation">
                                <img src="abc/heartAnimation.gif" alt="">
                            </div>
                        </div>
                        <div class="mewmew1">
                            <img src="abc/mewmew.gif" alt="">
                        </div>
                        <div class="mewmew2">
                            <img src="abc/mewmew.gif" alt="">
                        </div>
    ...
    <script>
        ...
        const textLetterP = "Chúc mừng sinh nhật cậu! Xin gửi lời chúc tới người tớ yêu thương nhất. Luôn vui vẻ, luôn hạnh phúc và luôn may mắn trong cuộc sống, ngày càng xinh đẹp. Tớ hy vọng rằng cậu sẽ có một ngày sinh nhật thật ý nghĩa và đáng nhớ. Xin gửi tất cả lời chúc tốt đẹp đến với cậu. Love You💗";
